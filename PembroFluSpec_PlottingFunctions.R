...
bivScatter <- function(data1, data2, name1, name2, xData, yData, fillParam, title, xLabel, yLabel)
{
  ...
  my_grob1 = grobTree(textGrob(annotationInfo1, x=0.05,  y=0.85, hjust=0, gp=gpar(col="#7FAEDB", fontsize=24)))
  my_grob2 = grobTree(textGrob(annotationInfo2, x=0.05,  y=0.75, hjust=0, gp=gpar(col="#FFB18C", fontsize=24)))
  return (
    ggplot() + 
